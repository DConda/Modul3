    ...
    public function testExample(): void
    {
        $this->browse(function (Browser $browser) {
            $browser->visit('http://127.0.0.1:8000/') // Visit the homepage
                    ...
                    ->pause(2000) // Wait for 2 seconds
                    ->ClickLink('Create Note') // Click the "Create Note" link
                    ->pause(2000) // Wait for 2 seconds
                    ->type("title", "Hello World") // Type the title in the title field
                    ->type("description", "This is a test note") // Type the description in the description field
                    ->press('CREATE'); // Press the "CREATE" button to save the note
        });
    }
}
